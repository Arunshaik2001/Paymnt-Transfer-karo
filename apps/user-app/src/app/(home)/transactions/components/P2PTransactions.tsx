...
const P2PTransactions: React.FC = () => {
  ...
  return (
    <div className="flex flex-col p-2 items-center lg:items-start mb-10">
      <div className="text-primaryText font-bold text-xl mb-5">
        Your Deposits
      </div>
      <div className="h-96 w-full overflow-y-auto border border-gray-300 rounded-lg p-4 bg-gray-100 shadow-lg lg:w-96">
